...
import { getAvailableModels, switchAIModel } from '../services/geminiService';
...
const Settings: React.FC<SettingsProps> = ({ netConfig, setNetConfig, addLog }) => {
  ...
  const handleModelChange = (model: string) => {
    ...
    addLog(`AI CORE: Switched to model ${model}`, "success");
  };
      ...
      <div className="bg-[#050505] border border-white/5 p-6 rounded-lg shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <h4 className="text-[8px] font-black text-purple-500 uppercase tracking-widest border-l-2 border-purple-500 pl-2">AI Model Configuration</h4>
              <div className="space-y-1">
                <label className="text-[7px] text-gray-500 uppercase font-black">HuggingFace Model</label>
                <select 
                  value={currentModel} 
                ...
                <div className="text-[6px] text-gray-600 font-black mt-1">
